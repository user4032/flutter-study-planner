...
**Student Diary** — це особистий щоденник для студентів, який допомагає організувати розклад пар, вести нотатки, отримувати нагадування та переглядати розклад через віджет на iOS.
...
Наступні кроки для GitHub
Створити репозиторій student-diary.

Додати README.md з текстом вище.
...
.idea/
.vscode/
Ініціалізувати репозиторій та зробити перший коміт:
